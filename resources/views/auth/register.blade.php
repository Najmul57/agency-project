...
@section('frontend_content')
    ...
    <div class="outer-box container my-5">
        <div class="row justify-content-center">
                ...
                <div class="inner-box">
                    <div class="icon-box">
                        <div class="icon-outer">
                            <img src="{{ asset('frontend/assets/image/register/free.png') }}" alt="">
                        </div>
                    </div>
                    <div class="price-box">
                    ...
                    <ul class="features">
                        <li class="true"><i class="fas fa-check"></i>Free Registration</li>
                        <li class="true"><i class="fas fa-check"></i>Student Portal</li>
                        <li class="true"><i class="fas fa-check"></i>Scholaship</li>
                        <li class="true"><i class="fas fa-check"></i>Admission Guideline</li>
                        <li class="true"><i class="fas fa-check"></i>Student Visa Guideline</li>
                        <li class="true"><i class="fas fa-check"></i>Travel Guideline</li>
                        <li class="true"><i class="fas fa-xmark" style="background:#F11D24"></i>Referral Earn</li>
                    </ul>
                    <div class="btn-box">
                        <a href="javascript::void()" class="theme-btn freeSignup">REGISTER NOW</a>
                    </div>
                </div>
            </div>
            ...
            <div class="pricing-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="icon-box">
                        <div class="icon-outer">
                            <img src="{{ asset('frontend/assets/image/register/primium.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="price-box">
                    ...
                    <ul class="features">
                        <li class="true"><i class="fas fa-check"></i>Student Portal</li>
                        <li class="true"><i class="fas fa-check"></i>Admission Guideline</li>
                        <li class="true"><i class="fas fa-check"></i>Scholarship</li>
                        <li class="true"><i class="fas fa-check"></i>30+ University Details</li>
                        <li class="true"><i class="fas fa-check"></i>Video Guideline</li>
                        <li class="true"><i class="fas fa-check"></i>Student Visa Guideline</li>
                        <li class="true"><i class="fas fa-check"></i>Travel Guideline</li>
                        <li class="true"><i class="fas fa-check"></i>Plus Referral Earn</li>
                        <li class="true"><i class="fas fa-check"></i>Membership Fees</li>
                        <li class="true"><i class="fas fa-check"></i>Adjustable With Tuition Fees</li>
                    </ul>
                    <div class="btn-box">
                        <a href="javascript::void()" class="theme-btn primiumSignup">REGISTER NOW</a>
                    </div>
                </div>
            </div>
            <!-- Pricing Block -->
            <div class="pricing-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="icon-box">
                        <div class="icon-outer">
                            <img src="{{ asset('frontend/assets/image/register/agent.png') }}" alt="">
                        </div>
                    </div>
                    <div class="price-box">
                    ...
                    <ul class="features">
                        <li class="true"><i class="fas fa-check"></i> Agent Portal</li>
                        <li class="true"><i class="fas fa-check"></i> Admission Guideline</li>
                        <li class="true"><i class="fas fa-check"></i> Scholarship</li>
                        <li class="true"><i class="fas fa-check"></i> 30+ University Details</li>
                        <li class="true"><i class="fas fa-check"></i> Video Guideline</li>
                        <li class="true"><i class="fas fa-check"></i> Student Visa Guideline</li>
                        <li class="true"><i class="fas fa-check"></i> Travel Guideline</li>
                        <li class="true"><i class="fas fa-check"></i> Referral Earn</li>
                        <li class="true"><i class="fas fa-check"></i> Membership Fees</li>
                        <li class="true"><i class="fas fa-check"></i> Refundable/Adjustable</li>
                    </ul>
                    <div class="btn-box">
                        <a href="javascript::void()" class="theme-btn primiumPartner">REGISTER NOW</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @php
        $primium__country = \App\Models\PrimiumCountry::orderBy('name', 'ASC')->get();
        $primium__university = \App\Models\PrimiumUniversity::orderBy('name', 'ASC')->get();
        $primium__course = \App\Models\PrimiumCourse::orderBy('name', 'ASC')->get();
        $primium__university_course = \App\Models\PrimiumUniversityCourse::orderBy('name', 'ASC')->get();
        $program_type = \App\Models\ProgramType::orderBy('name', 'ASC')->get();
    @endphp

    <div class="contact__area   free">
    ...
    <div class="contact__area  primium">
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="form">
            <h3 class="form-title">Primium Student</h3>
            @csrf
            <input type="hidden" name="is_primium" value="is_primium">
            <div class="steps">
                <ul class="step-tab-items d-none">
                    <li class="step-item active">1</li>
                    <li class="step-item">2</li>
                ...
                <div class="step-tabs">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-8 offset-md-2">
                                <div class="step-tab active " id="step-011">
                                    <h4 class="form-title-sc">Basic Information</h4>
                                    <div class="row align-items-center">
                                        <div class="col-md-6 col-sm-6 col-12">
                                            <div class="form-group mb-3">
                                    ...
                                    <div class="form-submit">
                                        <button class="form-btn" type="button" tab-target="step-022">Next</button>
                                    </div>
                                </div>
                                <div class="step-tab" id="step-022">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group d-flex align-items-center mb-2">
                                                <label for="o_level" style="width: 70%">10TH/'O' LEVEL<span
                                                        class="text-danger">*</span></label>
                                                <input type="file" name="o_level" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group d-flex align-items-center mb-2">
                                                <label for="a_level" style="width: 70%">12TH/'A' LEVEL<span
                                                        class="text-danger">*</span></label>
                                                <input type="file" name="a_level" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group d-flex align-items-center mb-2">
                                    ...
                                    <div class="form-submit grid-2">
                                        <button type="button" class="form-btn" tab-target="step-011">Previous</button>
                                        <button type="button" class="form-btn" tab-target="step-033">Next</button>
                                    </div>
                                </div>
                                <div class="step-tab" id="step-033">
                                    <h4 class="form-title-sc">Payment system</h4>

                                    <div class="form-group">
                                        <label for="">Amount</label>
                                        <input type="number" name="amount" class="form-control"
                                            placeholder="subscription amount" required id="amount" readonly>
                                        Primium Subscribtion Fees
                                        <span class="text-danger" id="subscription_fee">
                                            @if (isset($setting))
                                                <strong>{{ $setting->primium_subscription }}</strong>
                                            @else
                                                No settings found.
                                            @endif
                                        </span>
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="">Transiton Number</label>
                                        <input type="text" name="txt_number" class="form-control"
                                            placeholder="transition number" required>
                                    </div>

                                    <div class="form-submit grid-2">
                                        <button type="button" class="form-btn" tab-target="step-022">Previous</button>
                                        <button type="submit" class="form-btn">Submit</button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="contact__area  partner">
        <form method="POST" action="{{ route('partner.register') }}" enctype="multipart/form-data" class="form">
            <h3 class="form-title">Agent Portal</h3>
            @csrf
            <input type="hidden" name="is_primium" value="is__partner">
            <div class="steps">
                <ul class="step-tab-items d-none">
                    <li class="step-item active">1</li>
                    <li class="step-item">2</li>
                ...
                <div class="step-tabs">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-8 offset-md-2">
                                <div class="step-tab active " id="step-0111">
                                    <h4 class="form-title-sc">Basic Information</h4>
                                    ...
                                    <div class="form-submit">
                                        <button class="form-btn" type="button" tab-target="step-0222">Next</button>
                                    </div>
                                </div>
                                <div class="step-tab" id="step-0222">
                                    <h4 class="form-title-sc">Document Upload</h4>
                                    ...
                                    <div class="form-submit grid-2">
                                        <button type="button" class="form-btn" tab-target="step-0111">Previous</button>
                                        <button type="button" class="form-btn" tab-target="step-0333">Next</button>
                                    </div>
                                </div>
                                <div class="step-tab" id="step-0333">
                                    <h4 class="form-title-sc">Payment system</h4>

                                    <div class="form-group">
                                        <label for="">Amount</label>
                                        <input type="number" name="amount" class="form-control"
                                            placeholder="subscription amount" required id="amountPartner" readonly>
                                        Partner Subscribtion Fees
                                        <span class="text-danger" id="partner_subscription_fee">
                                            @if (isset($setting))
                                                <strong>{{ $setting->partner_subscription }}</strong>
                                            @else
                                                No settings found.
                                            @endif
                                        </span>
                                    ...
                                    <div class="form-submit grid-2">
                                        <button type="button" class="form-btn" tab-target="step-0222">Previous</button>
                                        <button type="submit" class="form-btn">Submit</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const subscriptionFeeSpan = document.getElementById('subscription_fee');
            const subscriptionFee = subscriptionFeeSpan.textContent.trim();
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const partnet_amountInput = document.getElementById('amountPartner');
            const partner_subscriptionFeeSpan = document.getElementById('partner_subscription_fee');
            const partner_subscriptionFee = partner_subscriptionFeeSpan.textContent.trim();

            partnet_amountInput.value = partner_subscriptionFee;
        });
    </script>
@endsection

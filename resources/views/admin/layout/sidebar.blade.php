    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('primium.university.list') }}"><i class="bx bx-right-arrow-alt"></i>University
                        List</a></li>
                <li> <a href="{{ route('program.type') }}"><i class="bx bx-right-arrow-alt"></i>Program Type</a>
                </li>
                <li> <a href="{{ route('primium.course.list') }}"><i class="bx bx-right-arrow-alt"></i>Department
                        List</a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('admin.payment.receipt') }}"><i class="bx bx-right-arrow-alt"></i>Payment
                        Receipt</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('admin.offer.letter') }}"><i class="bx bx-right-arrow-alt"></i>Offer
                        Letter</a></li>
                <li> <a href="{{ route('admin.admission.letter') }}"><i class="bx bx-right-arrow-alt"></i>Admission
                        Letter</a></li>
                <li> <a href="{{ route('admin.visa.letter') }}"><i class="bx bx-right-arrow-alt"></i>Visa
                        Permission
                        Letter</a></li>
                <li> <a href="{{ route('admin.another.letter') }}"><i class="bx bx-right-arrow-alt"></i>Another
                        Letter</a></li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('visa.application') }}"><i class="bx bx-right-arrow-alt"></i>Application
                        Copy</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('ticketing.guideline') }}"><i class="bx bx-right-arrow-alt"></i>Ticketing
                        Guideline</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('referance.guideline') }}"><i class="bx bx-right-arrow-alt"></i>Referance
                        Guideline</a>
                </li>
                <li> <a href="{{ route('admin.paymentreceipt.upload') }}"><i class="bx bx-right-arrow-alt"></i>Upload
                        Payment Receipt</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li> <a href="{{ route('letterverificaion.guideline') }}"><i class="bx bx-right-arrow-alt"></i>Letter
                        Verification Guideline</a>
                </li>
                <li> <a href="{{ route('document.verification') }}"><i class="bx bx-right-arrow-alt"></i>Document
                        Verification </a>
                </li>

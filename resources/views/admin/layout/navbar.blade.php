        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="{{ !empty($adminData->photo) ? url('/upload/admin_images/' . $adminData->photo) : url('upload/admin_images/no_image.jpg') }}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.logout') }}"><i
                                class='bx bx-home-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>

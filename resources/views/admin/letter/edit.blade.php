...
@section('admin_content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Letter Update</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('letter.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @if ($data->offer_letter)
                                <a href="{{ asset('upload/letter/' . $data->offer_letter) }}"
                                    target="_blank">{{ $data->offer_letter }}</a>
                            @endif
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @if ($data->admission_letter)
                                <a href="{{ asset('upload/letter/' . $data->admission_letter) }}"
                                    target="_blank">{{ $data->admission_letter }}</a>
                            @endif
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @enderror
                            @if ($data->visa_process_letter)
                                <a href="{{ asset('upload/letter/' . $data->visa_process_letter) }}"
                                    target="_blank">{{ $data->visa_process_letter }}</a>
                            @endif
                        </div>
                    </div>
                </div>

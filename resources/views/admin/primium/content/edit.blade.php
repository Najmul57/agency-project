...
@section('admin_content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('primium.content.update', $data->id) }}" method="post">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="course_id" required class="select2 form-control @error('course_id') is-invalid @enderror"
                        id="course_id">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="universitycourse_id" required
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="overview" id="overview" class="summernote" class="form-control @error('overview') is-invalid @enderror"
                        rows="10">{{ $data->overview }}</textarea>
                    @error('overview')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="criteria" id="criteria" class="summernote" class="form-control @error('criteria') is-invalid @enderror"
                        rows="10">{{ $data->criteria }}</textarea>
                    @error('criteria')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="scholarship" id="scholarship" class="summernote"
                        class="form-control @error('scholarship') is-invalid @enderror" rows="10">{{ $data->scholarship }}</textarea>
                    @error('scholarship')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="assistance" id="assistance" class="summernote"
                        class="form-control @error('assistance') is-invalid @enderror" rows="10">{{ $data->assistance }}</textarea>
                    @error('assistance')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>

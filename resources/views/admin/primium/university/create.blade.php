...
@section('admin_content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('primium.university.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="university_id"
                        class="form-control @error('university_id') is-invalid @enderror" placeholder="enter university id">
                    @error('university_id')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>

    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            @if (session('notification'))
                <div class="alert alert-{{ session('notification.alert-type') }}" id="alert">
            ...
            <a href="{{ url('/clear-cache-all') }}" style="color: white">Clear Cache</a>
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty($data->photo) ? asset('upload/student/' . $data->photo) : asset('upload/admin_images/user.jpg') }}"
                        class="user-img" alt="user avatar" />
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{ ucwords(Auth::user()->name) }}</p>
                        <small class="text-white">Channel Partner</small>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('partner.password.change') }}"><i
                                class="bx bx-lock"></i><span>Change
                                Password</span></a>
                    </li>
                    <li>
